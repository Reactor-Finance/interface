...
const tableVariants = cva(
  "grid hover:border-[#43444C] border transition-colors border-transparent items-center group text-sm text-right hover:bg-[#303136] gap-x-4 py-[10px] bg-neutral-1000 px-4 rounded-md",
  {
    variants: {
      cols: {
        "11": "lg:grid-cols-11",
