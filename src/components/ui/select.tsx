...
>(({ className, children, display, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(selectTriggerVariants({ display }), className)}
    {...props}
  >
    {children}
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative bg-neutral-1000 z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border " +
          " text-white shadow-md data-[state=open]:animate-in" +
